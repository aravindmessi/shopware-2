import { r as registerInstance, c as createEvent, h, H as Host } from './index-e608b2e3.js';
...
const Radio = class {
    ...
    render() {
        return (h(Host, { class: "radio-container", onClick: () => this.toggle(), role: "radio", tabIndex: "0", "aria-disabled": this.disabled ? 'true' : 'false', "aria-checked": `${this.checked}`, onFocus: () => this.onFocus(), onBlur: () => this.onBlur() }, h("input", { type: "radio", ref: el => this.radio = el }), h("label", null, h("span", { class: "text" }, h("slot", null)), h("br", null), this.label !== ''
