import { r as registerInstance, c as createEvent, h } from './index-e608b2e3.js';
...
const Modal = class {
    constructor(hostRef) {
         ...
         */
        this.visible = false;
        this.fwAction = createEvent(this, "fwAction", 7);
    ...
    renderFooter() {
        return this.customFooter
            ? h("slot", { name: "footer" })
            : (h("span", null, h("fw-button", { color: "secondary", onClick: () => this.closeModal() }, this.cancelText), h("fw-button", { color: "primary", onClick: () => this.fwAction.emit() }, this.successText)));
    }
    render() {
        return (h("div", { class: { 'modal-container': true, 'visible': this.visible } }, h("div", { class: { 'modal': true, [this.size]: true } }, h("div", { class: "modal-header-container" }, h("div", { class: "modal-header" }, this.icon !== '' ? this.renderIcon() : '', h("div", null, this.titleText, h("div", { class: "description" }, this.description))), h("button", { class: "close-btn", onClick: () => this.closeModal() }, h("fw-icon", { name: "cross-big" }))), h("div", { class: "content" }, h("slot", null)), this.hideFooter
            ? ''
            : (h("div", { class: "modal-footer-container" }, h("div", { class: "modal-footer" }, this.renderFooter()))))));
    }
