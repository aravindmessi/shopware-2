...
const Modal = class {
    constructor(hostRef) {
         ...
         */
        this.visible = false;
        this.fwAction = index.createEvent(this, "fwAction", 7);
    ...
    renderFooter() {
        return this.customFooter
            ...
            : (index.h("span", null, index.h("fw-button", { color: "secondary", onClick: () => this.closeModal() }, this.cancelText), index.h("fw-button", { color: "primary", onClick: () => this.fwAction.emit() }, this.successText)));
    }
    render() {
        return (index.h("div", { class: { 'modal-container': true, 'visible': this.visible } }, index.h("div", { class: { 'modal': true, [this.size]: true } }, index.h("div", { class: "modal-header-container" }, index.h("div", { class: "modal-header" }, this.icon !== '' ? this.renderIcon() : '', index.h("div", null, this.titleText, index.h("div", { class: "description" }, this.description))), index.h("button", { class: "close-btn", onClick: () => this.closeModal() }, index.h("fw-icon", { name: "cross-big" }))), index.h("div", { class: "content" }, index.h("slot", null)), this.hideFooter
            ? ''
            : (index.h("div", { class: "modal-footer-container" }, index.h("div", { class: "modal-footer" }, this.renderFooter()))))));
    }
