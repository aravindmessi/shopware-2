...
const Tabs = class {
    ...
    render() {
        return (index.h("div", { class: "tabs" }, index.h("ul", { role: "tablist", class: "tabs__items" }, this.tabs.map((tab, index$1) => index.h("li", { onClick: () => tab.disabled ? '' : this.activeTabIndex = index$1, class: "tabs__item" }, index.h("div", { id: '#tab-' + index$1, class: 'tabs__item__nav ' + (index$1 === this.activeTabIndex ? 'active' : '') + (tab.disabled ? 'disabled' : '') }, index.h("span", { class: "tab-title--tab-icon" }, tab.tabHeaderHtml
            ? index.h("span", { innerHTML: tab.tabHeaderHtml })
            : index.h("span", { class: "tab-title" }, tab.tabHeader)))))), index.h("div", { class: "tabs__content" }, index.h("slot", null))));
    }
