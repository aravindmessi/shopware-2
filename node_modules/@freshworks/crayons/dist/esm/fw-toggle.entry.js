import { r as registerInstance, c as createEvent, h } from './index-5957b9c5.js';
...
const Toggle = class {
    ...
    render() {
        return (h("div", { class: {
                'toggle-switch': true,
                [this.size]: true,
            }, onClick: () => this.toggle() }, h("input", { name: this.name, type: "checkbox", disabled: this.disabled, checked: this.checked, class: "checkboxClass" }), h("span", { class: {
                'slider': true,
                [this.size]: true,
            } })));
    }
